...
from crawler.settings import MONGO_URI, PROJECT_DIR
from crawler.items import ZhihuPeopleItem, ZhihuRelationItem
from crawler.tools.async import download_pic
